      ...
      <div className="w-full">
        ...
        <div className="grid grid-cols-12 gap-4">
              ...
              <div className="p-4 md:p-6 space-y-0">
                ...
                <div className="w-full p-4 border-b border-gray-100">
                  ...
                  <Textarea
                    ...
                    onChange={(e) => setDespachoData({...despachoData, observacoes: e.target.value})}
          ...
          <aside id="visualizacao-dfd-assinado" className="col-span-12 lg:col-span-4 w-full">
            ...
            {/* Card de Comentários */}
            <div className="rounded-2xl border shadow-sm overflow-hidden bg-white mt-4">
                  ...
                  {comentarios.map((comentario) => (
                    <div key={comentario.id} className="p-3 bg-gray-50 rounded-lg">
                      <div className="flex items-start justify-between mb-2">
                        <div className="text-sm font-medium text-gray-900">{comentario.autor}</div>
                        <div className="text-xs text-gray-500">{formatDate(comentario.data)}</div>
                      </div>
                      <div className="text-xs text-gray-600 mb-1">{comentario.cargo}</div>
