...
export default function ETPSignatureSection({
  ...
  const podeConcluir = isGSP || user?.id === cardData.responsavelEtapa.id;
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      placeholder="Adicione observações sobre a assinatura do ETP..."
                      className="min-h-[100px] mt-2 resize-none border-gray-200 focus:border-purple-300 focus:ring-purple-300"
                    />
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={setNotificarPartes}
              />
