...
export default function PageBar() {
  return (
    <header className="sticky top-[var(--safe-top)] z-30 bg-slate-50/95 backdrop-blur border-b px-[var(--gutter)]">
      <div className="h-[var(--pagebar-h)] flex items-center justify-between">
        {/* Breadcrumb + Título */}
